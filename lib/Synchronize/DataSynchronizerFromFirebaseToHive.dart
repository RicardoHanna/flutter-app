...
=======
  ...
  Future<List<String>> retrieveSeCodes(String usercode) async {
    ...
    try {
      // Send HTTP GET request to fetch seCodes from the server
      final response =
          await http.get(Uri.parse('${apiurl}getSeCodes?usercode=$usercode'));
  ...
  Future<List<String>> retrieveItemCodes(List<String> seCodes) async {
    ...
    try {
      for (String seCode in seCodes) {
        // Send HTTP GET request to fetch item codes from the server
        final response =
            await http.get(Uri.parse('${apiurl}getSalesItems?seCode=$seCode'));
        if (response.statusCode == 200) {
...
=======
  Future<void> _synchronizeSubMenu(
      int menucode, List<dynamic> subMenuData, Box<dynamic> groupBox) async {
    try {
      // Iterate over subMenuData
      for (var subMenu in subMenuData) {
        var groupcode = subMenu['groupcode'];
...
>>>>>>> 8eff638a690e042cbe9999aefb0a89f6e3a88659
  ...
  Future<void> synchronizeIESubMenu(int menucode, List<dynamic> subSyncData,
  ...
  Future<List<Map<String, dynamic>>> _fetchGeneralSettingsData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to retrieve general settings data: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<void> synchronizeSalesEmployeesItemsBrands(
    ...
    try {
      ...
      await _synchronizeSalesEmployeesItemsBrands(
          apiResponse, salesEmployeesItemsBrandsBox);
    } catch (e) {
      print(
          'Error synchronizing data from API to Hive for SalesEmployeesItemsBrands: $e');
    }
  }

  Future<List<Map<String, dynamic>>> _fetchSalesEmployeesItemsBrandsData(
      List<String> seCodes) async {
    List<Map<String, dynamic>> salesEmployeesItemsBrandsData = [];
    try {
      // Iterate over each seCode and fetch data for each one
      for (String seCode in seCodes) {
        ...
        if (response.statusCode == 200) {
          ...
          if (responseData is List) {
            ...
            print(
                'Invalid response format for sales employees items brands data');
          }
        } else {
          print(
              'Failed to retrieve sales employees items brands data for seCode $seCode: ${response.statusCode}');
        }
      }
    } catch (e) {
    ...
    try {
      for (String seCode in seCodes) {
        ...
        if (response.statusCode == 200) {
          ...
          print(
              'Failed to retrieve customer codes data for seCode $seCode: ${response.statusCode}');
        }
      }
    } catch (e) {
      print('Error retrieving customer codes: $e');
...
=======
  Future<List<Map<String, dynamic>>> _fetchCustomerAddressesData(
      List<String> custCodes) async {
    List<Map<String, dynamic>> addressesData = [];
    try {
      for (String custCode in custCodes) {
        final response = await http
            .get(Uri.parse('${apiurl}getCustomerAddresses?custCode=$custCode'));
        if (response.statusCode == 200) {
...
>>>>>>> 8eff638a690e042cbe9999aefb0a89f6e3a88659
          ...
          print(
              'Failed to retrieve customer addresses data for custCode $custCode: ${response.statusCode}');
        }
      }
    } catch (e) {
      print('Error fetching customer addresses data: $e');
...
>>>>>>> 8eff638a690e042cbe9999aefb0a89f6e3a88659
      ...
      Set<String> addressesKeys = Set.from(addressesData.map((data) =>
          '${data['cmpCode']}${data['addressID']}${data['custCode']}'));
      Set<String> hiveAddressesKeys = Set.from(addresses.keys);
...
//-------------------------------------------------------------------------------------------------
  ...
  Future<List<Map<String, dynamic>>> _fetchCustomerBrandsSpecialPriceData(
      List<String> custCodes) async {
    List<Map<String, dynamic>> customerBrandsSpecialPriceData = [];
    try {
      // Iterate over each custCode and fetch data for each one
      for (String custCode in custCodes) {
        // Make API call to fetch customer brands special price data
        var response = await http.get(Uri.parse(
            '${apiurl}getCustomerBrandsSpecialPrice?custCode=$custCode'));
        if (response.statusCode == 200) {
          // Parse the response data
          dynamic responseData = jsonDecode(response.body);
          if (responseData is List) {
            ...
            print(
                'Invalid response format for customer brands special price data');
          }
        } else {
          print(
              'Failed to retrieve customer brands special price data for custCode $custCode: ${response.statusCode}');
        }
      }
    } catch (e) {
...
//-------------------------------------------------------------------------------------------------
  ...
  Future<List<Map<String, dynamic>>> _fetchCustomerGroupsSpecialPriceData(
      List<String> custCodes) async {
    List<Map<String, dynamic>> customerGroupsSpecialPriceData = [];
    try {
      // Iterate over each custCode and fetch data for each one
      for (String custCode in custCodes) {
        // Make API call to fetch customer groups special price data
        var response = await http.get(Uri.parse(
            '${apiurl}getCustomerGroupsSpecialPrice?custCode=$custCode'));
        if (response.statusCode == 200) {
          // Parse the response data
          dynamic responseData = jsonDecode(response.body);
          if (responseData is List) {
            ...
            print(
                'Invalid response format for customer groups special price data');
          }
        } else {
          print(
              'Failed to retrieve customer groups special price data for custCode $custCode: ${response.statusCode}');
        }
      }
    } catch (e) {
...
//-------------------------------------------------------------------------------------------------
  ...
  Future<void> synchronizeDataPriceListsAutho() async {
    try {
      ...
      print(
          'Error synchronizing data from API to Hive for price list authorizations: $e');
    }
  }
