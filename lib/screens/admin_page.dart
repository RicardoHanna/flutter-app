...
import 'package:project/screens/admin_wms_settings_page.dart';
...
class _AdminPageState extends State<AdminPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> data = <String>[
      AppLocalizations.of(context)!.adminusers,
      AppLocalizations.of(context)!.adminusergroup,
      AppLocalizations.of(context)!.authorizations,
      AppLocalizations.of(context)!.generalSettings,
      AppLocalizations.of(context)!.companiesSettings,
      'Wms Settings'
    ];
    ...
    final Map<String, IconData> iconData = {
      ...
      'Wms Settings':Icons.warehouse
    };

    final Map<String, int> menuCodes = {
      AppLocalizations.of(context)!.adminusers:
          AdminSubMenu.ADMIN_USERS_MENU_CODE,
      AppLocalizations.of(context)!.adminusergroup:
          AdminSubMenu.SETTINGS_USERSGROUP_MENU_CODE,
      AppLocalizations.of(context)!.authorizations:
          AdminSubMenu.AUTHORIZATIONS_MENU_CODE,
      AppLocalizations.of(context)!.generalSettings:
          AdminSubMenu.GENERAL_SETTINGS_MENU_CODE,
      AppLocalizations.of(context)!.companiesSettings:
          AdminSubMenu.COMPANIES_SETTINGS_MENU_CODE,
      'Wms Settings':AdminSubMenu.WMS_SETTINGS_MENY_CODE
    };

    final Map<String, Widget> formWidgets = {
      AppLocalizations.of(context)!.adminusers: AdminUsersPage(
        appNotifier: widget.appNotifier,
      ),
      AppLocalizations.of(context)!.adminusergroup: AdminUsersGroupPage(
        appNotifier: widget.appNotifier,
      ),
      AppLocalizations.of(context)!.authorizations: AdminAuthorizationsPage(
        appNotifier: widget.appNotifier,
      ),
      AppLocalizations.of(context)!.generalSettings:
          GeneralSettings(appNotifier: widget.appNotifier),
      AppLocalizations.of(context)!.companiesSettings:
          CompaniesSettings(appNotifier: widget.appNotifier),
      'Wms Settings':WmsSettings(appNotifier: widget.appNotifier, userCode: widget.usercode,)
    };
    _appTextStyle = TextStyle(fontSize: widget.appNotifier.fontSize.toDouble());
    return Scaffold(
      appBar: AppBar(
        title:
            Text(AppLocalizations.of(context)!.adminPage, style: _appTextStyle),
      ),
      body: Padding(
